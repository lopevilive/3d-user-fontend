...
const modelCfg = [
  {
    path: '/dist/model/tmp/main.gltf',
    exec: (md, url) => {
      md.formatCameraPos([0.53, 1.75, 3.94], [0.42, .95, -0.31])
      md.loadHdr('/dist/hdr/buikslotermeerplein_1k.hdr')
      ...
      // md.setNormalMap('Obj3d66-4750728-35-395', '/img/BBpMpePwfHyvZihLDmrlYczTboxvVUgM.jpg')
      md.setRoughnessMap('Obj3d66-4750728-35-395', '/dist/img/vf1oairg_2K_Roughness.jpg')
    
      md.setMaterial('Obj3d66-4750728-3-834', {roughness: 1,metalness: 0.35}) // 地板
      md.setMap('Obj3d66-4750728-3-834', '/dist/img/wood/5311727364379_.pic_hd.jpg')
    }
  }
]
