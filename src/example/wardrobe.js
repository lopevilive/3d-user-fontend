...
export const init = async () => {
  ...
  await md.loadModel('/src/assets/model/wardrobe/scene.gltf');
  md.light.addPointLight({pos: [1.5, 2, 0.2],intensity: 10 }) // 添加点光源
  md.addAssistance() // 添加辅助工具
  md.formatCameraPos([25, 173, 370], [17, 108, -18])
  md.loadHdr('/src/assets/hdr/zwartkops_straight_morning_1k.hdr')

  md.setMap('door_R__0','/src/assets/img/WQdvmdeepVaZVvNKbcOFKwTiPakmetBM.jpg')
  md.setMap('wardrobe__0','/src/assets/img/WQdvmdeepVaZVvNKbcOFKwTiPakmetBM.jpg')
  md.setMap('door_L__0','/src/assets/img/WQdvmdeepVaZVvNKbcOFKwTiPakmetBM.jpg')
