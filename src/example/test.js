...
export const init = async () => {
  ...
  // md.setMap('Obj3d66-4750728-35-395', '/img/wood/5311727364379_.pic_hd.jpg')
  // md.setNormalMap('Obj3d66-4750728-35-395', '/img/vf1oairg_2K_Normal.jpg')
  // md.setRoughnessMap('Obj3d66-4750728-35-395', '/img/vf1oairg_2K_Roughness.jpg')

  // md.setMaterial('Obj3d66-4750728-3-834', {roughness: 1,metalness: 0.35}) // 地板
  // md.setMap('Obj3d66-4750728-3-834', '/img/wood/5311727364379_.pic_hd.jpg')
  ...
  md.assistance.rangeReplaceColor([0,100], true)
}